...
public:
	...
	CVector5D( const CSameVector & rhs )
	{
		static_cast<CVectorND<5>&>(*this) = rhs;
	}
	...
	// NOTE: This methods is intended to be called with a vector that only has 1 non-zero component equal to 1 or -1.
	...
	// NOTE: This method is intended to be called with a vector that only has 1 unit magnitude component equal to 1 or -1.
